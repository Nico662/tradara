...
const ASSETS = [
  { name: 'BTC/USD',  tf: '15m', vol: 0.025, cat: 'crypto',      binance: 'BTCUSDT',  yahoo: null,        alphavantage: null,  base: () => 28000 + Math.random() * 40000 },
  { name: 'ETH/USD',  tf: '15m', vol: 0.030, cat: 'crypto',      binance: 'ETHUSDT',  yahoo: null,        alphavantage: null,  base: () => 1200  + Math.random() * 2400  },
  { name: 'SOL/USD',  tf: '15m', vol: 0.035, cat: 'crypto',      binance: 'SOLUSDT',  yahoo: null,        alphavantage: null,  base: () => 80    + Math.random() * 120   },
  { name: 'XRP/USD',  tf: '15m', vol: 0.030, cat: 'crypto',      binance: 'XRPUSDT',  yahoo: null,        alphavantage: null,  base: () => 0.5   + Math.random() * 2     },
  { name: 'BNB/USD',  tf: '15m', vol: 0.025, cat: 'crypto',      binance: 'BNBUSDT',  yahoo: null,        alphavantage: null,  base: () => 200   + Math.random() * 400   },
  { name: 'DOGE/USD', tf: '15m', vol: 0.040, cat: 'crypto',      binance: 'DOGEUSDT', yahoo: null,        alphavantage: null,  base: () => 0.05  + Math.random() * 0.3   },
  { name: 'LINK/USD', tf: '15m', vol: 0.035, cat: 'crypto',      binance: 'LINKUSDT', yahoo: null,        alphavantage: null,  base: () => 5     + Math.random() * 20    },
  { name: 'AVAX/USD', tf: '15m', vol: 0.035, cat: 'crypto',      binance: 'AVAXUSDT', yahoo: null,        alphavantage: null,  base: () => 10    + Math.random() * 50    },
  { name: 'ADA/USD',  tf: '15m', vol: 0.030, cat: 'crypto',      binance: 'ADAUSDT',  yahoo: null,        alphavantage: null,  base: () => 0.2   + Math.random() * 1     },
  { name: 'DOT/USD',  tf: '15m', vol: 0.035, cat: 'crypto',      binance: 'DOTUSDT',  yahoo: null,        alphavantage: null,  base: () => 3     + Math.random() * 15    },
  ...
  { name: 'S&P 500',  tf: '15m', vol: 0.012, cat: 'indices',     binance: null, yahoo: null, alphavantage: 'SPY',  base: () => 3800  + Math.random() * 2000  },
  { name: 'NASDAQ',   tf: '15m', vol: 0.014, cat: 'indices',     binance: null, yahoo: null, alphavantage: 'QQQ',  base: () => 11000 + Math.random() * 5000  },
  { name: 'DOW',      tf: '15m', vol: 0.010, cat: 'indices',     binance: null, yahoo: null, alphavantage: 'DIA',  base: () => 30000 + Math.random() * 8000  },
  { name: 'GOLD',     tf: '15m', vol: 0.008, cat: 'commodities', binance: null, yahoo: null, alphavantage: 'GLD',  base: () => 1700  + Math.random() * 700   },
  { name: 'SILVER',   tf: '15m', vol: 0.015, cat: 'commodities', binance: null, yahoo: null, alphavantage: 'SLV',  base: () => 20    + Math.random() * 10    },
  { name: 'OIL/USD',  tf: '15m', vol: 0.020, cat: 'commodities', binance: null, yahoo: null, alphavantage: 'USO',  base: () => 60    + Math.random() * 40    },
];
