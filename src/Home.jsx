    ...
    <div id="gtm-root">
      ...
      <div style={{ padding: '16px 16px 24px', position: 'relative', zIndex: 2 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          ...
          <button
            onClick={() => onSelect('tournament')}
            style={{ width: '100%', background: 'linear-gradient(135deg, rgba(248,113,113,0.06), transparent)', border: '1px solid rgba(248,113,113,0.45)', borderRadius: 'var(--radius-lg)', padding: '18px 16px', display: 'flex', alignItems: 'center', gap: '14px', cursor: 'pointer', transition: 'transform 0.1s', textAlign: 'left', animation: 'fadeInUp 0.4s cubic-bezier(0.4,0,0.2,1) 0.13s both', boxShadow: '0 0 16px rgba(248,113,113,0.08)' }}
            onMouseDown={e => e.currentTarget.style.transform = 'scale(0.98)'}
            onMouseUp={e => e.currentTarget.style.transform = 'scale(1)'}
            onTouchStart={e => e.currentTarget.style.transform = 'scale(0.98)'}
            onTouchEnd={e => e.currentTarget.style.transform = 'scale(1)'}
