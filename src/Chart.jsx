    ...
    const timer = setTimeout(() => {
      ...
      loadCandles.then(candles => {
        ...
        if (asset._dailyVisible) {
          ...
          const start       = Math.floor(Math.random() * maxStart);
          const visibleCount = FOREX.includes(asset.name) ? 60 : 80;
          candlesRef.current    = candles.slice(start, start + visibleCount);
          revealPoolRef.current = candles.slice(start + visibleCount, start + visibleCount + 20);
        }
